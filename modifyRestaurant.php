...
<form id="formModifyRestaurant" action="modifyRestaurant.php" method="POST">
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <p class="text-muted m-b-30 font-14">Here are Modify Restaurant Company </p>


                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Registration Id</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" name="registrationId" value="<?php echo $registrationId ?>" id="registrationId" placeholder="Enter Register Id">
                                </div>
                                <div class="col-sm-4">
                                    &nbsp;<input type="submit" value="Search Restaurant" class="btn btn-success" name="btnSearch" id="btnSearch" onclick="getData()">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="name" id="name" value="<?php echo $name ?>" placeholder="Enter Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="address" id="address" value="<?php echo $address ?>" placeholder="Enter Address">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="email" id="email" value="<?php echo $email?>" placeholder="Enter Email">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="tel" id="tel" value="<?php echo $tel ?>" placeholder="Enter Telephone">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" multiple="multiple" name="days[]" data-placeholder="Select Dates">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="fromTime" id="fromTime"  data-placeholder="Select Start Time">
                                        <option><?php echo $fromTime?></option>
...
<!--                                &nbsp;<input type="submit" value="Search Restaurant" class="btn btn-primary" name="btnSearch" id="btnSearch" onclick="getData()">-->
<!--                            </div>-->
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"></label>
                                &nbsp;<input type="submit" value="Update Restaurant" class="btn btn-primary" name="btnUpdate" id="btnUpdate">
                            </div>
